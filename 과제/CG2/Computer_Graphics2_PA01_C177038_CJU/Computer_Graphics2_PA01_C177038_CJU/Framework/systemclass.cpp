...
bool SystemClass::Frame()
{
	...
	if (m_Input->IsKeyDown('5') || m_Input->IsKeyDown(VK_NUMPAD5))
	{
	...
	if (m_Input->IsKeyDown('6') || m_Input->IsKeyDown(VK_NUMPAD6))
	{
	...
	if (m_Input->IsKeyDown('7') || m_Input->IsKeyDown(VK_NUMPAD7))
	{
		if (!prevKeyDown)
		{
	...
	if (m_Input->IsKeyDown('8') || m_Input->IsKeyDown(VK_NUMPAD8))
	{
		m_Graphics->IncreaseIntensity();
	}

	if (m_Input->IsKeyDown('9') || m_Input->IsKeyDown(VK_NUMPAD9))
	{
