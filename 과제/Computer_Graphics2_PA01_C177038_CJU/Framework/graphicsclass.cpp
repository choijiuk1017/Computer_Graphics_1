...
//	m_Camera->SetPosition(0.0f, 0.5f, -3.0f);	// for chair
	...
	m_Light1->SetDiffuseColor(10.0f, 0.0f, 0.0f, 1.0f);
	...
	m_Light2->SetDiffuseColor(0.0f, 10.0f, 0.0f, 1.0f);
	...
	m_Light3->SetDiffuseColor(0.0f, 0.0f, 10.0f, 1.0f);
	m_Light3->SetPosition(0.0f, 1.0f, -3.0f);
...
bool GraphicsClass::Render(float rotation)
{
	...
	for (int i = 0; i < 4; i++)
	{
		...
		/*result = m_PointLightShader->Render(m_D3D->GetDeviceContext(), m_Models[i]->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix,
			m_Models[i]->GetTexture(), diffuseColor, lightPosition);*/
