...
//	m_Camera->SetPosition(0.0f, 0.5f, -3.0f);	// for chair model
	...
	result = m_Models[3]->Initialize2DPlane(m_D3D->GetDevice(), L"./data/Ground.dds");
...
bool GraphicsClass::Render(float rotation)
{
	...
	for (int i = 0; i < 4; i++)
	{
		...
		case 3:
			worldMatrix *= XMMatrixScaling(200.0f, 200.0f, 1.0f);
			worldMatrix *= XMMatrixRotationX(XM_PI / 2.5);
			worldMatrix *= XMMatrixTranslation(0.0f, -10.0f, 150.0f);
